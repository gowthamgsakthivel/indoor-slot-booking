  ...
  return (
    <div className="min-h-screen bg-(--background) flex flex-col text-white pb-24 font-sans relative">
      ...
      <main className="flex-1 px-6 w-full max-w-4xl mx-auto relative z-10 flex flex-col pt-8">
        ...
        <h1 className="text-display mt-8 text-[3rem] leading-[1.05] font-black md:text-7xl">
          Book Your <br />
          <span className="text-(--orange) italic drop-shadow-[0_0_20px_rgba(255,107,0,0.4)] block -ml-2">Court</span>
          Instantly
        </h1>

        <p className="mt-5 text-sm md:text-base font-medium text-white/60 leading-relaxed max-w-sm">
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-5 mt-6 overflow-x-auto pb-6 scrollbar-hide snap-x">
             
             {/* Gallery Image 1 - Generated by AI and saved to public/images */}
             <div className="min-w-70 h-85 rounded-4xl snap-center relative overflow-hidden shadow-2xl border border-white/5 bg-[#141414]">
               <img src="/images/court1.png" alt="Arena Court" className="absolute inset-0 w-full h-full object-cover" />
             ...
             {/* Gallery Image 2 - High-quality unsplash fallback for failed generation */}
             <div className="min-w-70 h-85 rounded-4xl snap-center relative overflow-hidden shadow-2xl border border-white/5 bg-[#141414]">
               <img src="https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Badminton Shuttlecock" className="absolute inset-0 w-full h-full object-cover" />
               <div className="absolute inset-0 bg-linear-to-t from-[#0c0c0e] via-[rgba(12,12,14,0.4)] to-transparent opacity-90" />
               <div className="absolute bottom-6 left-6 pr-6">
             ...
             {/* Gallery Card 3 - Call to action */}
             <div className="min-w-70 h-85 rounded-4xl snap-center relative overflow-hidden shadow-2xl border border-(--orange)/30 bg-[#1c140d] flex items-center justify-center cursor-pointer group hover:bg-[#251a11] transition-colors">
        ...
        <div className="mt-8 mb-12">
            <div className="h-55 w-full rounded-[2.5rem] bg-[#121212] border border-white/10 relative overflow-hidden p-8 flex flex-col justify-end shadow-2xl group cursor-pointer hover:border-(--orange)/40 transition-colors">
              ...
              <div className="relative z-10 -mt-2">
                <div className="w-14 h-14 bg-[#1c140d] rounded-full border border-(--orange)/30 flex items-center justify-center mb-5 shadow-[0_0_15px_rgba(255,107,0,0.15)]">
                   <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--orange)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="drop-shadow-[0_0_6px_rgba(255,107,0,0.6)]">
